package com.jaiaxn.distributed.system.aop;
 ...
 * @author: wang.jiaxin
 * @date: 2019年04月01日
 * @description: 禁止fastJson使用asm反系列化
 **/
@Aspect
@Component
@Slf4j
public class ServiceLogManagerAop {
    static {
        /*
         * jdk1.8下，若接口的缺省方法未被重写，则fastjson反系列化可能报错：java.lang.IncompatibleClassChangeError: Found interface xxx, but class was expected
    ...
    @Around("execution(* com.jaiaxn.distributed.system.service.*.*(..))")
